...
parser.add_argument('--early', dest='early', help='show plots', default=False, action = 'store_true')
parser.add_argument('--late', dest='late', help='show plots', default=False, action = 'store_true')
